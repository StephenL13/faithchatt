...
module.exports.run = async(client, message, args, prefix) => {
    ...
    const successEmbed = new MessageEmbed()
        .setColor('#ffd100')
        .setDescription('<:Unstaged:880650957925519441> **Bible study channel is now locked.**\n\nTune in next time by [checking out our schedules](https://discord.com/channels/839708279973478430/839965374967054386/936968689608163388) on <#936968689608163388>. Thanks for joining with us. God bless you.')
